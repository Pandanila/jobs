...
const VACANCIES = [
  ...
  { id:5, company:'VK', position:'Маркетолог', sphere:'Маркетинг', format:'Офис', location:'Москва', salary:'90 000 — 130 000 ₽', tags:['smm','таргет','аналитика'], color:'#0077FF', likes:413, questions:['Покажи кейс из портфолио','Какие инструменты используешь?'] },
];
